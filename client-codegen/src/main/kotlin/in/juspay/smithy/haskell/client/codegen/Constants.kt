...
object Http {
    ...
    val HttpClient: Symbol =
        HttpClientModule
            .toBuilder()
            .name("httpLbs")
            .namespace(CLIENT_MODULE, ".")
            .build()
    val HttpTypes: Symbol =
        HttpTypesModule
            .toBuilder()
            .name("##INVALID_SYMBOL##")
            .build()

    val DefaultHttpManagerSettings: Symbol =
        HttpClientModule
            .toBuilder()
