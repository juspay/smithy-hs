...
testHttpLabels :: Com.Example.ExampleServiceClient.ExampleServiceClient -> Com.Example.Model.TestHttpLabelsInput.TestHttpLabelsInputBuilder () -> IO (Either TestHttpLabelsError Com.Example.Model.TestHttpLabelsOutput.TestHttpLabelsOutput)
testHttpLabels client builder =
    ...
    in Com.Example.Utility.runOperation endpoint manager setAuth (Com.Example.Model.TestHttpLabelsInput.build builder)
